document.addEventListener("DOMContentLoaded", () => {
    ...
    localStorage.setItem('welcomeMessage', 'Welcome to My PLP Software Journey!');
    ...
    document.getElementById('startAnimationButton').addEventListener('click', () => {
        ...
        setTimeout(() => box.classList.remove('animate'), 3000); // Remove animation class after 3 seconds
    });
});